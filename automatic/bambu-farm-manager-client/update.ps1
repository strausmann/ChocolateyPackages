...
function global:au_GetLatest {
  ...
  $link = Find-Link -html $html -role 'client'
  if (-not $link) { throw "Could not find a Windows .exe link for CLIENT on $releases" }
  ...
  if (-not $ver) { throw "Could not parse CLIENT version from page or link context." }
