...
- Powershell 5+.
- [Chocolatey Automatic Package Updater Module](https://github.com/strausmann/ChocolateyPackages): `Install-Module au` or `cinst au`.

In order to setup AppVeyor update runner please take a look at the AU wiki [AppVeyor section](https://github.com/strausmann/ChocolateyPackages/wiki/AppVeyor).

## Create a package

To create a new package see [Creating the package updater script](https://github.com/strausmann/ChocolateyPackages/automatic#creating-the-package-updater-script).
...
To see how versions behave when package update is forced see the [force documentation](https://github.com/strausmann/ChocolateyPackages/blob/master/automatic/README.md#force-update).
...
* Set your environment variables. See [AU wiki](https://github.com/strausmann/ChocolateyPackages/wiki#environment-variables) for details.
