...
$packageArgs = @{
  ...
  softwareName  = 'Microsoft SQL Server Migration Assistant for Access*'  #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  fileType      = 'msi'
